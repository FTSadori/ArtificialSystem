...
namespace Story
{
	std::unordered_map<Friendliness, std::unordered_map<Awareness, Endings>> EndingChooser::s_table = {
		...
		{ Friendliness::MAX, {{Awareness::LOW, Endings::BaseFriend}, {Awareness::MEDIUM, Endings::OneOrTrue}, {Awareness::RZERO, Endings::OneOrTrue}, {Awareness::RMEDIUM, Endings::NaNFriend}, {Awareness::RZERO, Endings::NaNKilledPlus}}},
	};
}